...
def getsumoftree(t):
    if t.children == []:
        ...
        res = [getsumoftree(x) for x in t.children]
        return sum(res) + t.label
...
def cumulative_sum(t):
    ...
    """
    if t.children == []:
        return Tree(getsumoftree(t))
    else:
        child = [cumulative_sum(x) for x in t.children]
        return Tree(getsumoftree(t), child)
